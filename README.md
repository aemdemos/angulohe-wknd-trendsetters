...
## Environments
- Preview: https://main--angulohe-wknd-trendsetters--aemdemos.aem.page/
- Live: https://main--angulohe-wknd-trendsetters--aemdemos.aem.live/
...
1. Open the `angulohe-wknd-trendsetters` directory in your favorite IDE and start coding :)
